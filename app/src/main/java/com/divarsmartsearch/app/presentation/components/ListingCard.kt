...
import com.divarsmartsearch.app.presentation.effects.ConfettiHost
import com.divarsmartsearch.app.presentation.effects.Flip3D
import com.divarsmartsearch.app.presentation.effects.glassEffect
import com.divarsmartsearch.app.presentation.effects.tilt3D
...
fun ListingCard(
    ...
    var saveButtonCenter by remember { mutableStateOf(Offset.Zero) }
    ...
    Card(
        ...
        modifier = modifier
            ...
            // Drag a finger across the card to see it tilt in 3D like a
            // physical object, springing back flat on release.
            .tilt3D()
            // Frosted-glass fill + top-highlight border replaces the flat
            // surfaceVariant fill below — supplies its own background and
            // border, so the card's own colors/border are turned off.
        ...
        Column(modifier = Modifier.padding(16.dp)) {
            ...
            Row(
                ...
                IconButton(
                    onClick = {
                        // Small celebratory reward for saving a listing —
                        // burst originates from this button's own position.
                        ConfettiHost.burst(saveButtonCenter)
                        onSave()
                    },
                    modifier = Modifier.onGloballyPositioned { coordinates ->
                        saveButtonCenter = coordinates.boundsInRoot().center
                    },
                ) {
                    Icon(
